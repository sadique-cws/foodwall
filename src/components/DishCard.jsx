...
const DishCard = (props) => {
  ...
  return (
    <div className='flex flex-col flex-1 bg-white border-slate-500 border rounded-lg overflow-hidden'>
        <img src={"/dish/" + props.dish.image} className='w-full h-[110px]' alt="" />
        <div className="px-3 py-2">
            ...
            <div className="flex gap-3">
              {
                showMinus && <button className="bg-red-700 text-white px-2 flex-1 justify-center pb-1 pt rounded-lg flex items-center text-3xl" onClick={handleMinus}><span>-</span></button>
              }
              
              <span className="px-2 flex-1 justify-center pb-1 pt rounded-lg flex items-center text-3xl">{counter}</span>
              <button className="bg-green-700 text-white px-2 flex-1 justify-center pb-1 pt rounded-lg flex items-center text-3xl" onClick={handlePlus}><span>+</span></button>
            </div>
        </div>
    </div>
  )
